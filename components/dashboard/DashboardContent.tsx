...
const greetings: [number, string[]][] = [
    [5,  ["Hey, night owl", "Still up?", "Burning the midnight oil", "Why are you awake?", "The night is young"]],
    [12, ["Good morning", "Rise and shine", "Morning", "Wakey wakey", "Top of the morning", "Ready to crush it?"]],
    [17, ["Good afternoon", "Hey there", "Afternoon", "Hope the day's treating you well", "Halfway through"]],
    [21, ["Good evening", "Evening", "Winding down?", "Almost there", "End of the grind"]],
];
...
const getGreeting = (name: string) => {
    ...
    const pool = greetings.find(([limit]) => h < limit)?.[1] ?? greetings[0][1];
    return `${pick(pool)}, ${name.split(" ")[0]}`;
};
