...
export const getMockTest = async (id: string): Promise<MockTestDetail | null> => {
  try {
...
export const getMockTestSections = async (id: string, page = 1, pageSize = 20): Promise<PagedResult<MockTestSection>> => {
  try {
